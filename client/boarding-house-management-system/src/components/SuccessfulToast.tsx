...
const SuccessfulToast = ({
  successfulLabel,
  setIsSuccessfulToastVisible,
}: {
  successfulLabel: string;
  setIsSuccessfulToastVisible: (value: boolean) => void;
}) => {
  return (
    <motion.div
      initial={{
    ...
    >
      ...
      <div className="ml-3 text-sm font-normal">
        <em className="text-amber-500">Successfully</em>
        <br />
        <p className="text-xs font-medium">{successfulLabel}</p>
      </div>
      <button
        type="button"
